...
import { generatePicture, fetchPictureSuccessful } from '../Actions/generate.actions';

function fetchNewPicture() {
    return axios.get('https://api.nasa.gov/planetary/apod?api_key=tB7sce2zsRulhQG0U7jtQvLlh0TjLWKFZMnEvsNz');
}
